...
training_args = TrainingArguments(
    output_dir="detr-resnet-50-finetuned-20-epochs-boat-dataset",
    ...
    push_to_hub=True,
    hub_model_id="ARG-NCTU/detr-resnet-50-finetuned-20-epochs-boat-dataset",
)
...
trainer.push_to_hub(commit_message='detr-resnet-50-finetuned-boat-dataset 30 epoch')
